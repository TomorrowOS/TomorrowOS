...
| Platforms | [Tizen](./os/tizen.md), [BrightSign](./os/brightsign.md), [webOS](./os/webos.md), [Android](./os/android.md), [Windows](./os/windows.md) | Install, setup, capabilities and known limits |
