...
description: "Map of TomorrowOS docs: getting started, API, guides, platforms, and certification."
---
...
| --- | --- | --- |
| Getting started | [Beginners guide](./guides/beginners-guide), [Developer guide](./guides/developer-guide) | Product overview, then SDK setup, pairing and publish |
| API | [API overview](./api/overview), [Capability matrix](./capabilities/capability-matrix) | Shipped `device.*` commands and support tracking |
| Guides | [Assets](./guides/assets-and-atomic-activation), [Widgets / ZIP](./guides/widget-zip-packages), [Black-gap playback](./guides/black-gap-playback) | Media publish, widgets, transition behaviour |
| Platforms | [Tizen](./os/tizen), [BrightSign](./os/brightsign), [webOS](./os/webos), [Android](./os/android), [Windows](./os/windows) | Install, setup, capabilities and known limits |
| Testing | [Certification](./testing/certification) | How to prove support on real model + firmware |
...
For the full command list, see [API overview](./api/overview).
...
| If you want to… | Read |
| --- | --- |
| Understand the product | [Beginners guide](./guides/beginners-guide) |
| Build or host a CMS | [Developer guide](./guides/developer-guide) |
| Learn the command surface | [API overview](./api/overview) |
| Deploy on Samsung | [Tizen](./os/tizen) |
| Deploy on BrightSign | [BrightSign](./os/brightsign) |
| Certify a model + firmware | [Certification](./testing/certification) |
